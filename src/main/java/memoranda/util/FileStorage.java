...
import main.java.memoranda.INoteListImpl;
...
public class FileStorage implements Storage {
    ...
    /**
     * @see main.java.memoranda.util.Storage#storeNote(INote)
     */
    public void storeNote(INote INote, javax.swing.text.Document doc) {
        ...
        /*DEBUG*/System.out.println("[DEBUG] Save INote: "+ filename);
        ...
        /*String filename = JN_DOCPATH + INote.getProject().getID() + "/";
        doc.putProperty(javax.swing.text.Document.TitleProperty, INote.getTitle());
        CalendarDate d = INote.getDate();
    ...
    /**
     * @see main.java.memoranda.util.Storage#openNote(INote)
     */
...
//            Util.debug("Open INote: " + filename);
//        	Util.debug("INote Title: " + INote.getTitle());
...
//        CalendarDate d = INote.getDate();
    ...
    public void removeNote(INote INote) {
        ...
        /*DEBUG*/
        System.out.println("[DEBUG] Remove INote:" + getNotePath(INote));
        f.delete();
    }
    ...
    /**
     * @see main.java.memoranda.util.Storage#removeProject(IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#createProjectStorage(IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#openNoteList(IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#storeNoteList(INoteList, IProject)
     */
    public void storeNoteList(INoteList nl, IProject prj) {
        /*DEBUG*/
        System.out.println(
            "[DEBUG] Save INote list: "
                + JN_DOCPATH
                + prj.getID()
                + File.separator
                + ".notes");
    ...
    /**
     * @see main.java.memoranda.util.Storage#openResourcesList(IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#storeResourcesList(IResourcesList, IProject)
     */
